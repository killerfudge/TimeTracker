...
<html lang="en">
    ...
    <body>
        <a id='logout_link' class='right' href='/<?php if($_SERVER['HTTP_HOST'] == 'localhost'){echo "TimeTracker/";} ?>?action=Logout'>Logout</a>
        <a id='home_link' href='/<?php if($_SERVER['HTTP_HOST'] == 'localhost'){echo "TimeTracker/";} ?>campaign/?action=leaveCampaign'>Campaign List</a>
        <article>
            ...
            <?php
                ...
                {
                    echo "<form method='POST' action='".$root."campaign/'>";
